...
(function() {
	...
	var canSendBinaryString = (
        ...
        || (window.Blob && window.Uint8Array && window.ProgressEvent)
	...
	var handleImage = function (settings, dataurl, info, file) {
		var img = new Image();
	...
	var handleForm = function (settings, type, data, info) {
		if (canSendFormData && type === 'file') {
			...
			+ 'content-disposition: form-data; name="' + settings.name + '";'
